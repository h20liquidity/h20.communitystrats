...
contract Obv4Script is StrategyTests, Script {
    ...
    function run() external {
        ...
        // BASE_WLTH.safeApprove(address(obv4), depositAmount);
        // obv4.deposit2(address(BASE_WLTH), VAULT_ID, depositAmount,new ActionV1[](0));  

        vm.stopBroadcast();

        console2.log("hhelo world");
    }
}